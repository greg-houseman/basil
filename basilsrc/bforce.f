...
C           IERR=1
          ELSE
            ...
            WRITE(LSC,1001)I,MSNODE(I),
     :                     PTLOC(1,I),PTLOC(2,I),PTLOC(3,I),XP,YP
            WRITE(LUW,1001)I,MSNODE(I),
     :                     PTLOC(1,I),PTLOC(2,I),PTLOC(3,I),XP,YP
          END IF
        END IF
  120 CONTINUE
1001  FORMAT('SERIES: for entry ',I3,' using element ',I6,','
     :       ' local coords ',F9.4,',',F9.4,',',F9.4,
